...
abstract class Kohana_ORM_MPTT extends ORM
{
	/**
	 * @access  public
	...
	{
		//$this->_db->query(NULL, 'LOCK TABLE '.$this->_db->quote_table($this->_table_name).' AS '.$this->_db->quote_column($this->_object_name).' WRITE', TRUE);
		/*
