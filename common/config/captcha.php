...
return array(
	'default' => array(
		...
		'width'      => 140,
		'height'     => 32,
		'complexity' => mt_rand(4, 5),
		'background' => '',
		'fontpath'   => MODPATH.'captcha/fonts/',
		'fonts'      => array('comic.ttf', 'cambria.ttc', 'AGPresquireBoldOblique.ttf'),
		'promote'    => 10,
	),
	/**
	 * Words of varying length for Captcha_Word to pick from
	 * Note: all Unicode characters should work, but not everyone can type them, 
	 * so be careful with that (no japanese/chinese captcha please ;))
	 */
	'words' => array(
		'cd', 'tv', 'it', 'to', 'be', 'or',
